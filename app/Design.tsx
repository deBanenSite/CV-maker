    ...
    <div id="design">
      ...
      <Modal show={showModal} title="Maak nu een account aan!" close={() => setShowModal(false)}>
        <div className="text--center">
          <p>Upload jouw gemaakte CV in je account om te starten.<br></br>
             Klik hiervoor rechtsboven op account aanmaken.<br></br>
             CV aanpassen? Upload deze opnieuw in de CV maker.</p>
        </div>
      </Modal>
    </div>
  )
